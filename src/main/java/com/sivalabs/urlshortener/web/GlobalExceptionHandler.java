...
import com.sivalabs.urlshortener.domain.exceptions.ResourceNotFoundException;
...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    record ApiErrors(Errors errors) {
        public static ApiErrors from(List<String> messages) {
            return new ApiErrors(new Errors(messages));
        }
    }
